class Datris < Formula
  ...
  url "https://files.pythonhosted.org/packages/source/d/datris-mcp-server/datris_mcp_server-1.6.19.tar.gz"
  sha256 "be4d4e206728a982eea524a0e2268052b51db04747d37548b532218d262fc8e5"
